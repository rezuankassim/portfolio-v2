...
const WorkSection: FC = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative mt-20 overflow-clip bg-primary-blue-3 px-32 py-56"
    >
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-6 flex flex-col gap-y-12">
            ...
            <div className="flex gap-x-8">
              ...
              <ul className="flex flex-1 list-disc flex-col gap-y-2 text-lg text-white">
                <li>
                  Led a small front-end developer team, helped them to clear their doubts in their
                  heads when doing their tasks, and brainstormed about the new features to be
                  implemented.
                </li>
                <li>
                  Revamped the current website using frameworks such as Vue.js and Node.js to let
                  the developer not need to learn the legacy framework the company built years ago.
                </li>
              </ul>
            </div>
            ...
            <div className="flex gap-x-8">
              ...
              <ul className="flex flex-1 list-disc flex-col gap-y-2 text-lg text-white">
                <li>
                  Maintained the existing system and enhanced the system to be able to process more
                  than 1,000 requests in a matter of minutes.
                </li>
                <li>
                  Developed an in-house analytic system to enable higher-ups to view analytics from
                  multiple applications from a centralized system.
                </li>
              </ul>
            </div>
